...
export default class Home extends React.Component {
  ...
  render () {
    ...
    const linkIssues = (<a
      ...
      target="_blank"><span {...messages.dropIssue} /></a>)
    return (
      <div>
        <div className="header">
          <span {...messages.welcome}>
            {text => <h1>{text}</h1>}
          </span>
        </div>
        <div className="content">
          <p>
            <span {...messages.intro} values={{ linkRedux, linkRouter }} />
          </p>
          <p>
            <span {...messages.intro2} values={{ br: (<br/>) }} />
          </p>
          <p>
            <span {...messages.intro3} values={{ linkIssues }} />
          </p>
        </div>
      </div>
    )
